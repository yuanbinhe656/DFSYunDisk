...
// 设置json包
QByteArray RankingList::setFileListJosn(int start, int count)
{
    /*
        {
            "start": 0,
...
// 获取共享文件列表
void RankingList::getUserFileList()
{
    ...
    */
    QByteArray data = setFileListJosn(m_start, m_count);
...
void RankingList::refreshList()
{
    ...
    {
        ui->tableWidget->removeRow(0);   //每次删除首行
